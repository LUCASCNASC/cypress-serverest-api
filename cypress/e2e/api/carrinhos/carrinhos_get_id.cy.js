describe('Endpoint - GET /carrinhos/{_id}', () => {
  ...
  it('Status code as 200: It should successfully search for a cart by ID.', () => {
    cy.request({
      method: 'GET',
  ...
  it('Status code as 400: It should return an error when trying to search for a non-existent cart.', () => {
