describe('Endpoint - GET /usuarios/{_id}', () => {
  ...
  it('Status code as 200: It should successfully search for a user by ID.', () => {
  ...
  it('Status code as 400: It should return error when trying to search for a non-existent user ID.', () => {
  ...
  it('Status code as 400: It should return error when trying to search for an invalid ID format.', () => {
