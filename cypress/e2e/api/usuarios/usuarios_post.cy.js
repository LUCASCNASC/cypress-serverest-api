describe('Endpoint - POST /usuarios', () => {
  ...
  it('Status code as 201: It should successfully register a user - Dynamic Data', () => {
  ...
  it('Status code as 400: It should validate that it is not allowed to register a user with an email already in use.', () => {
