describe('Endpoint - PUT /usuarios/{_id}', () => {
  ...
  it('Status code as 200: It should successfully change a user.', () => {
  ...
  it('Status code as 201: It should register a new user via PUT if the ID does not exist.', () => {
  ...
  it('Status code as 400: It should return error when trying to use an email already in use.', () => {
    const timestamp = Date.now();
